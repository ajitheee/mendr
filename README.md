...
```sh
npx github:ajitheee/mendr#v0.4.5-alpha audit . --install
```
...
```sh
npx github:ajitheee/mendr#v0.4.5-alpha fix-llm .
```
...
```sh
npx github:ajitheee/mendr#v0.4.5-alpha fix-llm https://github.com/someone/their-repo
```

It never writes to your working tree on its own. The default is print-only. When you're ready to apply:

```sh
npx github:ajitheee/mendr#v0.4.5-alpha fix-llm . --write
```
...
```sh
npx github:ajitheee/mendr#v0.4.5-alpha fix-llm . -o mendr.patch && git apply mendr.patch
```
...
```sh
npx github:ajitheee/mendr#v0.4.5-alpha watch .
```
...
```bash
npx github:ajitheee/mendr#v0.4.5-alpha audit . --offline
```
...
```sh
npx github:ajitheee/mendr#v0.4.5-alpha watch --install
```
...
```sh
npx github:ajitheee/mendr#v0.4.5-alpha fix-llm . --fail-on tierB
```
