...
*Method, for disclosure: I run a scanner that checks pinned model ids against published shutdown dates. It surfaced these ids but classified them as data references rather than call sites; I confirmed the live call sites by reading the files.*